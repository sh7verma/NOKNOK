...
import com.app.noknok.adapters.PhoneAdapter;
...
public class CountryCodeActivity extends Activity {
	...
	public String CountryName[] = { "Abkhazia", "Afghanistan", "Albania", "Algeria",
	...
	public String CountryCode[] = { "7840", "93", "355", "213", "1684", "376", "244",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		font_light = "fonts/Ubuntu-Regular.ttf";
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (adapter.getItemViewType(position) == 0) {
					Log.e("clicked", "item");
					PhoneAdapter.Item it = (PhoneAdapter.Item) adapter
							.getItem(position);
	...
	public void updateList() {
		...
		for (double i = 1; i <= indexListSize; i = i + delta) {
			...
			tmpTV.setTextColor(Color.parseColor("#0D70B3"));
			tmpTV.setText(tmpLetter);
	...
	public void create_view(List<String> countries) {
		...
		lv.invalidate();
		List<PhoneAdapter.Row> rows = new ArrayList<PhoneAdapter.Row>();
		int start = 0;
		int end = 0;
		...
		for (String country : countries) {
			...
			if (!firstLetter.equals(previousLetter)) {
				rows.add(new PhoneAdapter.Section(firstLetter));
				sections.put(firstLetter, start);
			}

			// Add the country to the list
			rows.add(new PhoneAdapter.Item(country));
