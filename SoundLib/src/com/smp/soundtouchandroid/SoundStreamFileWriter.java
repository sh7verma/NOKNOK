...
public class SoundStreamFileWriter extends SoundStreamRunnable implements OnProgressChangedListener
{
	...
	public SoundStreamFileWriter(int id, String fileNameIn, String fileNameOut,
			float tempo, float pitchSemi, AudioDuration audioDuration) throws IOException
	{
		super(id, fileNameIn, tempo, pitchSemi, audioDuration);
	...
	public SoundStreamFileWriter(int id, String fileNameIn, String fileNameOut,
			float tempo, float pitchSemi, float rate, AudioDuration audioDuration) throws IOException
	{
		super(id, fileNameIn, tempo, pitchSemi, audioDuration);
		setRate(rate);
		this.fileNameOut = fileNameOut;
